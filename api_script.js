document.addEventListener('DOMContentLoaded', () => {
    ...
    const displayListings = data => {
        ...
        listings.forEach(listing => {
            ...
            el.innerHTML =
            `
            <h1>${listing.program_nid}</h1>
            <p>${listing.description}</p>
            <video width="400" controls>
                <source src="https://lbs-usp-hls-live.cmore.se/group1/bbr-event2/live.isml/10367287.m3u8" type="application/x-mpegURL">
            </video>
            `
            // Getting error Error while loading key skd://fairplay-license.drm.technology/license/live
